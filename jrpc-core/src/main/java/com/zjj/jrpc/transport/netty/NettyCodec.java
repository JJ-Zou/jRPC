...
import com.zjj.jrpc.codec.Codec;
import com.zjj.jrpc.common.JRpcURLParamType;
import com.zjj.jrpc.common.utils.EncoderUtils;
...
import com.zjj.jrpc.rpc.Message;
...
public class NettyCodec extends ByteToMessageCodec<Message> {
    ...
    protected void encode(ChannelHandlerContext ctx, Message msg, ByteBuf out) throws Exception {
        ...
        byte[] bytes = EncoderUtils.wrapperHeader(data, JRpcURLParamType.NETTY_MAGIC_NUM.getShortValue(), (byte) 0, msg.getRequestId());
    ...
    protected void decode(ChannelHandlerContext ctx, ByteBuf byteBuf, List<Object> out) throws Exception {
        ...
        if (nettyMagicNum != JRpcURLParamType.NETTY_MAGIC_NUM.getShortValue()) {
