...
import zjj.registry.zookeeper.ZookeeperRegistry;
import zjj.registry.zookeeper.ZookeeperRegistryFactory;
...
public class TestRegistry {
    ...
    public void registry() throws Exception {
        ...
        JRpcURL jRpcURL = new JRpcURL("META_INF/jrpc", "127.0.0.1", 20855, "zjj.registry.zookeeper", parameters);
        ...
        create.invoke(registry, "/META_INF/jrpc/default_rpc/zjj.registry.zookeeper/service/132.22.22.1:9999", false);
